// app/api/downloader/spotify/route.ts
/**
 * CR Ahzamycode
 * Spotify downloader via j2download.com (autolink)
 * Support track, album & playlist → MP3 320 kbps
 * GET  : ?url=<spotify-link>
 * POST : JSON {url:<spotify-link>}
 */
...
async function spotdl(url: string) {
  const baseHeaders = {
